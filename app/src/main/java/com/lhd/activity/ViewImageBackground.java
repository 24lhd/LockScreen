...
public class ViewImageBackground extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       fullManHinh();
        ...
        ((Button) findViewById(R.id.btn_set_image_backgroud)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Hawk.put(Main.IMAGE_BACKGROUND, new BackgroundImageLockScreen(Config.getBackgroundImageLockScreens().get(index).getPickImage()));
                finish();
                finish();
    ...
    private void loadImageView(int indexImage) {
        BackgroundImageLockScreen.loadImage(this, Config.getBackgroundImageLockScreens().get(indexImage).getPickImage(),((ImageView) findViewById(R.id.im_bg_view_selected)));
